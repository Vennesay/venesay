...
bot.on('message', async message => {
	...
	.setAuthor(`© 2019 Oye Bot™`, `https://i.imgur.com/V80KM2u.jpg`, "vk.com/omgyoureyes")
        ...
        rep_message.edit(`` +
            `**Приветствую! Вы попали в канал поддержки Discord сервера сообщетсва omg. your eyes.**\n` +
            `**Тут Вы сможете задать вопрос модераторам сервера!**\n\n` +
            `**Количество вопросов за все время: ${+info_rep[0] + 2}**\n` +
        ...
        await message.guild.createChannel(`ticket-${+info_rep[0] + 2}`).then(async channel => {
            message.delete();    
...
if (message.content == '/archive'){
 ...
 if(message.content.startsWith(`приватный контент`)) {
     message.channel.sendMessage(`приватный контент`);
 }
